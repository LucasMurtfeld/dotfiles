...
```shell-session
NivaLada@htb[/htb]$ cat /etc/exports 
...
```shell-session
NivaLada@htb[/htb]$ sudo nmap 10.129.14.128 -p111,2049 -sV -sC
...
```shell-session
NivaLada@htb[/htb]$ sudo nmap --script nfs* 10.129.14.128 -sV -p111,2049
...
```shell-session
NivaLada@htb[/htb]$ showmount -e 10.129.14.128
...
```shell-session
NivaLada@htb[/htb]$ mkdir target-NFS
NivaLada@htb[/htb]$ sudo mount -t nfs 10.129.14.128:/ ./target-NFS/ -o nolock
NivaLada@htb[/htb]$ cd target-NFS
NivaLada@htb[/htb]$ tree .
...
```shell-session
NivaLada@htb[/htb]$ cd ..
NivaLada@htb[/htb]$ sudo umount ./target-NFS
```